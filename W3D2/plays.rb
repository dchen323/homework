...
class Playwright
  ...
  def get_plays
    ...
    plays = PlayerDBConnection.instance.execute(<<-SQL, @id)
      SELECT
        *
      FROM
        plays
...
class Play
  ...
  def self.find_by_title(title)
    plays = PlayerDBConnection.instance.execute(<<-SQL title)
  ...
  def self.find_by_playwright(name)
    ...
    plays = PlayerDBConnection.instance.execute(<<-SQL playwright
      SELECT
        *
      FROM
        plays
