...
#runtime of 100000x for bubble sort will be 2**2 times slower than the time it takes
#to run 50000x. The runtime of 100000x for merge sort will be ~2log2x slower than
#the time it takes to run 50000x
require 'io/console'
require 'benchmark'
